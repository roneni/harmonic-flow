...
// ── Dark olive-gunmetal panel — matches Stitch reference ─────────────────
const PANEL_METAL = [
...
function PhillipsScrew({ uid }: { uid: string }) {
  return (
    <svg width="24" height="24" viewBox="0 0 20 20" aria-hidden="true">
      ...
      <circle cx="10" cy="10.8" r="9"   fill="rgba(0,0,0,0.60)" />
...
export function StudioInputUpload() {
  ...
  // Green glow — idle: visible ring; processing: blazing; complete: flash
  const vuGlow =
    panelState === "idle"
      ? [
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          paddingBottom: "clamp(18px, 2vw, 32px)",
        }}
      >
        {/* Corner screws */}
        ...
        {/* Column: header sits directly over ring centre */}
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <p style={{
            ...
            textShadow:    "0 1px 3px rgba(0,0,0,0.8), 0 0 20px rgba(132,204,22,0.08)",
          }}>
            Studio Input Upload
          </p>

          {/* Machined inset frame + ring */}
          <div style={{ position: "relative" }}>

            {/* ── Inset frame — machined rectangular recess ── */}
            <div style={{
              padding:      "clamp(14px, 1.8vw, 24px)",
              borderRadius: 8,
              background:   "linear-gradient(180deg, #2e2e2c 0%, #363634 50%, #2a2a28 100%)",
              ...
              <div style={{
                ...
                {/* ── VU circle at 65% — green halo emanates from here ── */}
                <div
                  role="button"
                  tabIndex={0}
            ...
            {/* ── SIGNAL INPUT — absolute right of frame ── */}
            <div style={{
              position:   "absolute",
              left:       "calc(100% + clamp(16px, 2vw, 32px))",
              top:        "50%",
          ...
          {/* ── PROCESSING — centred below frame ── */}
          <div style={{
            display:        "flex",
            alignItems:     "center",
            justifyContent: "center",
